    ...
    <tr><td>
      <div dojoType="SplitContainer" orientation="horizontal" sizerWidth="3" activeSizing="true" class="borderDiv"
        ...
        <div dojoType="ContentPane" sizeMin="20" sizeShare="20" style="overflow:auto;padding:2px;">
            ...
            <p>Welcome to Mango database! If you look to the right of this message, you will see your set sensors. For help, click <a href="${pageContext.request.contextPath}/help.shtm">here</a></p>
            <h3>New Additions to Mango</h3>
            <h5>Landing Page</h5>
            <p>You are looking at the first added feature of Mango, this landing page.</p>
            <h5>More Charts</h5>
            <p>If you visit the <a href="${pageContext.request.contextPath}/reports.shtm">Reports Page</a>, you will now be able to access more charts</p>
            <h5>Dark Mode</h5>
            <p>If you visit the <a href="${pageContext.request.contextPath}/system_settings.shtm">Settings Page</a>, you can now enable dark mode (thankfully)</p>
